...
export default function Footer () {
    return (
        <>
            <div className="min-h-64 w-screen flex flex-col gap-4 from-[#c6cace] to-[#f1f5f9] dark:from-[#0e223f] dark:to-[#0a1630] bg-linear-to-t py-5 px-10 border-t border-gray-300 dark:border-[#334e68]">
                <div className="flex flex-col justify-center items-center gap-4">
                    <div className="flex flex-col gap-3">
                        <h1 className="text-base font-extrabold text-gray-900 dark:text-[#768a9e]"> Built With ❤️ Using Next.JS</h1>
                ...
                <div className="flex flex-col justify-center items-center gap-4"> 
                    <p className="text-gray-800 dark:text-gray-300">©2026 Farel</p>
                </div>
            </div>
        </>
    )
