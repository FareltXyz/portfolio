...
export default function Page() {
    ...
    return (
        <>
            <Navbar />
            <div className="w-screen min-h-screen flex flex-col gap-y-5 bg-[#0a1630]">
                <div className="w-full min-h-screen grid grid-cols-1 lg:grid-cols-2  pt-24 px-5 py-7">
                    <div className="flex flex-col items-center p-5 lg:px-14 my-auto">
                        <div className="w-full lg:max-w-md xl:max-w-lg px-5  rounded-lg bg-[#102a43] border border-[#334e68] flex-flex-col gap-4 py-4">
                           <form onSubmit={webhook}>
                            ...
                            <div className="flex flex-row flex-wrap lg:flex-nowrap gap-y-5 gap-x-5 my-5">
                                <div className="flex flex-col gap-y-0.5">
                                    ...
                                    <div className="bg-[#0a1929] border border-[#334e68] text-black dark:text-white w-full px-4 rounded-sm inline-flex items-center py-2 gap-5"> 
                            ...
                            <div className="flex flex-col gap-y-0.5 dark:text-white">
                                <p>Message:</p>
                                <textarea name="message" className="bg-[#0a1929] h-40 resize-none focus:outline-0 p-3"></textarea>
                            </div>
                            <button className="dark:text-white hover:bg-cyan-800  focus:bg-cyan-800 inline-flex gap-x-4 w-full bg-cyan-700 rounded-md my-3 mt-5 py-2 lg:py-3 items-center justify-center">
                                Send message
                                <FaPaperPlane />
                            </button>
                           </form>
